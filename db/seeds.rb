...
User.create!(username: "admin", email: "admin@email.com", password: "12345")

movie.posters = [
  Pathname.new(Rails.root.join("db/img/time-of-gypsies.jpg")).open,
  Pathname.new(Rails.root.join("db/img/la-mala-educacion.jpg")).open,
  Pathname.new(Rails.root.join("db/img/oldboy.jpg")).open,
  Pathname.new(Rails.root.join("db/img/the-holy-mountain.jpg")).open
]
movieData = [
  {
    img: movie.posters[0],
    synopsys:"Perhan (Davor Dujmovic) is a Gypsy teenager with the ability to move objects with his mind. A criminal named Ahmed convinces him to leave his devoted grandmother (Ljubica Adzovic) and loving girlfriend, and to use his powers to make some money illegally. While becoming a man and learning the trade of crime, the boy searches for his sister (who was supposed to have a leg operation) and tries to save money to realize his fantasy of returning home to marry the woman of his dreams. This film won Emir Kusturica an award at the 1989 Cannes Film Festival for his direction and was the first feature to be filmed with its entire dialogue in the Gypsy language, Romany.(by Perry Seibert)",
    release_year: 1990,
  ...
  },
  {
    ...
    img: movie.posters[2],
    synopsys:"Dae-Su is an obnoxious drunk bailed from the police station yet again by a friend. However, he's abducted from the street and wakes up in a cell, where he remains for the next 15 years, drugged unconscious when human contact is unavoidable, otherwise with only the television as company. And then, suddenly released, he is invited to track down his jailor with a denouement that is simply stunning.",
    release_year: 2003,
    country: "South Korea",
  ...
  },
  {
    ...
    img: movie.posters[3],
    synopsys:"In a corrupt, greed-fueled world, a powerful alchemist leads a Christ-like character and seven materialistic figures to the Holy Mountain, where they hope to achieve enlightenment.",
    release_year: 1973,
    country: "Mexico",
